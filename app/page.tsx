      ...
      <div className="max-w-6xl w-full grid md:grid-cols-2 gap-8 items-center">
        ...
        <div className="text-white space-y-6">
          ...
          <p className="text-xl text-indigo-100">
            Upload your speaking practice videos and receive AI-powered feedback on your tone, pace, clarity, and delivery.
          </p>
          <ul className="space-y-3 text-lg">
            <li className="flex items-start">
              <svg className="w-6 h-6 mr-2 flex-shrink-0 mt-1" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
              </svg>
              Upload MP4 videos up to 150MB
            </li>
            <li className="flex items-start">
              <svg className="w-6 h-6 mr-2 flex-shrink-0 mt-1" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
